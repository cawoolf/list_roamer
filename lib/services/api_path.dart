...
class APIPath {
  ...
  static String locationMarkerPath({required String userId, required String listId, required String markerId}) => 'users/$userId/lists/$listId/location_markers/$markerId'; // Returns all location Markers for the list
